#include "GestorPrueba.h"

GestorP::GestorP() {}
GestorP::GestorP(JuegoP* j):juego{j}{}

void GestorP::empezarPartida() {
...
Nodo* GestorP::encontrarJugador(const std::string& nombreJugador) {
